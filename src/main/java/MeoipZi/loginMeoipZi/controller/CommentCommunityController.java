...
import MeoipZi.loginMeoipZi.service.CommentCommunityService;
import MeoipZi.loginMeoipZi.service.CommentOutfitService;
import MeoipZi.loginMeoipZi.service.CommentShortFormService;
...
public class CommentCommunityController {
    ...
    public ResponseEntity<?> saveCommentCommunity(@PathVariable("communityId") Long communityId, CommentCommunityRequestDTO commentCommunityRecDTO) throws Exception {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
    ...
    public ResponseEntity<?> saveReplyCommunity(@PathVariable("communityId") Long communityId, CommentReplyRequestDTO commentReplyRecDTO) throws Exception {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
