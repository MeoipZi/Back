...
import MeoipZi.loginMeoipZi.dto.CommentShortFormRequestDTO;
import MeoipZi.loginMeoipZi.dto.CommentShortFormResponseDTO;
import MeoipZi.loginMeoipZi.exception.NotFoundMemberException;
import MeoipZi.loginMeoipZi.repository.CommentShortFormRepository;
...
public class CommentShortFormService {
    ...
    public ResponseEntity<?> saveComment(Long shortformId, CommentShortFormRequestDTO commentShortFormRequestDTO) throws Exception{
        ...
        shortForm.setCommentCounts(shortForm.getCommentCounts()+1);
